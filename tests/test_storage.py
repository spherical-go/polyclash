...
def test_join_game(storage, test_client, socketio_client):
    ...
    result1 = test_client.post(
        "/sphgo/joined_status", json={"token": result0.json["black_key"]}
    )
    ...
    result2 = test_client.post(
        "/sphgo/joined_status", json={"token": result0.json["white_key"]}
    )
...
def test_game_not_ready(storage, test_client, socketio_client):
    ...
    result3 = test_client.post(
        "/sphgo/ready", json={"token": result0.json["black_key"]}
    )
    assert result3.status_code == 200
...
def test_game_ready(storage, test_client, socketio_client):
    ...
    result6 = test_client.post(
        "/sphgo/ready", json={"token": result0.json["white_key"]}
    )
...
def test_game_ready2(storage, test_client, socketio_client):
    ...
    result6 = test_client.post(
        "/sphgo/ready_status", json={"token": result0.json["black_key"]}
    )
    assert result6.status_code == 200
    assert result6.json["status"]["black"]
    assert not result6.json["status"]["white"]

    result7 = test_client.post(
        "/sphgo/ready", json={"token": result0.json["white_key"]}
    )
    assert result7.status_code == 200
    assert result7.json["status"]["black"]

    result8 = test_client.post(
        "/sphgo/ready_status", json={"token": result0.json["white_key"]}
    )
...
def test_game_play(storage, test_client, socketio_client):
    ...
    result9 = test_client.post(
        "/sphgo/play",
        json={
            "token": result0.json["black_key"],
            "role": "black",
            "steps": 0,
            "play": [5, 6, 7, 8, 9],
        },
    ...
    result10 = test_client.post(
        "/sphgo/play",
        json={
            "token": result0.json["white_key"],
            "role": "white",
            "steps": 1,
            "play": [0, 1, 2, 3, 4],
        },
...
def test_game_close(storage, test_client, socketio_client):
    ...
    result11 = test_client.post(
        "/sphgo/close", json={"token": result0.json["white_key"]}
    )
